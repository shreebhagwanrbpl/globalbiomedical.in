    ...
    <section className="section-padding bg-slate-50">
      <div className="container-custom">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-[42px] bg-slate-950 p-10 lg:p-20 text-white border border-slate-900"
        >

          {/* Decorative glowing premium orbs */}
          <div className="absolute -top-24 -left-24 w-96 h-96 bg-rose-500/15 rounded-full blur-[100px] pointer-events-none" />
          <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-pink-500/15 rounded-full blur-[100px] pointer-events-none" />
